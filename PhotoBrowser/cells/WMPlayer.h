 ...
 */
@property (strong,nonatomic)void (^canleClick)(BOOL isyes);
- (instancetype)initWithFrame:(CGRect)frame videoURLStr:(NSString *)videoURLStr WithPlayerItem:(AVPlayerItem *)playerItem;
- (void)play;
- (void)pause;
